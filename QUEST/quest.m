function q = quest(b10, r10, b20, r20, b30, r30, a1, a2, a3)
...
r2 = r20/norm(r20);
r3 = r30/norm(r30);
B = a1*(transpose(b1)*r1) + a2*(transpose(b2)*r2) + a3*(transpose(b3)*r3); %Calculating B matrix - to be used later
S = B + transpose(B);
sigma = trace(B);
...
lambda0 = a1 + a2 + a3; % Close assumption for eigen value of K matrix
syms lambda;
